...
mode.add_command(label="标准版")
mode.add_command(label="无限版")
...
frequency_frame.grid(row=0, column=1, padx=2, pady=2)
...
weight_frame.grid(row=0, column=2, padx=2, pady=2)
...
second_button_frame.grid(row=1, columnspan=3, padx=3, pady=3)
